        ...
        <div className="h-full">
          <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-slate-900 shadow-lg shadow-slate-950/5">
            <div className="mb-5">
              ...
              <span className="text-slate-900 dark:text-slate-200 font-bold text-4xl pb-2">{isAnnual ? 'Free' : 'Free'}</span>
              </div>
              <div className="text-sm text-slate-500 mb-5">There are many variations available, but the majority have suffered.</div>
                <a className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-transparent border border-teal-300 border-2 px-3.5 py-2.5 text-md font-medium text-slate-900 shadow-lg shadow-teal-950/10 hover:bg-teal-300 hover:text-slate-900 hover:font-semibold focus-visible:outline-none focus-visible:ring focus-visible:ring-teal-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0">
                  Purchase Plan
                </a>
              </div>
            ...
            <ul className="text-slate-600 dark:text-slate-400 text-sm space-y-3 grow">
              ...
              <svg className="w-3 h-3 fill-teal-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="h-full dark">
        <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-transparent border border-black border-4 dark:border-black shadow shadow-slate-950/5">
          ...
          <div className="pb-2 text-slate-900 dark:text-slate-200 font-semibold mb-1">
              ...
              <span className="text-slate-900 dark:text-slate-200 font-bold text-3xl">N</span>
              <span className="text-slate-900 dark:text-slate-200 font-bold text-4xl">{isAnnual ? '1500' : '2500'}</span>
              <span className="text-black font-medium">/{isAnnual ? 'yearly' : 'monthly'}</span>
              </div>
              <div className="text-sm text-white mb-5">There are many variations available, but the majority have suffered.</div>
                <a className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-black px-3.5 py-2.5 text-md font-medium text-white shadow-lg shadow-teal-950/10 hover:bg-teal-300 hover:text-slate-900 hover:font-semibold focus-visible:outline-none focus-visible:ring focus-visible:ring-teal-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0">
                  Purchase Plan
                </a>
        ...
        <div className="h-full">
          <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-slate-900 shadow-lg shadow-slate-950/5">
            <div className="mb-5">
              ...
              <span className="text-slate-900 dark:text-slate-200 font-bold text-3xl">N</span>
              <span className="text-slate-900 dark:text-slate-200 font-bold text-4xl">{isAnnual ? '4500' : '5500'}</span>
              <span className="text-teal-300 font-medium">/{isAnnual ? 'yearly' : 'monthly'}</span>
              </div>
              <div className="text-sm text-slate-500 mb-5">There are many variations available, but the majority have suffered.</div>
